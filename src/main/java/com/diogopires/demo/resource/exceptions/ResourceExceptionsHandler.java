package com.diogopires.demo.resource.exceptions;
...
public class ResourceExceptionsHandler {
  ...
  public ResponseEntity<StandardError> dataIntegrity(DataIntegrityException e,HttpServletRequest request ){
    ...
    StandardError err = new StandardError(System.currentTimeMillis(),HttpStatus.BAD_REQUEST.value(),"Dados Incorretos" ,e.getMessage(),request.getRequestURI());
